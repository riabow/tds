...
class Dogovor (models.Model):
    ...
    PRODLENIE = models.CharField(max_length=10, default='', blank=True)
    ADDED_ON = models.CharField(max_length=20, default='', blank=True)
    PRIMECHANIE = models.CharField(max_length=150, default='', blank=True)
    Key_num = models.CharField(max_length=100, default='', blank=True)
    Sys_pass = models.CharField(max_length=100, default='', blank=True)
    Lock_pass = models.CharField(max_length=100, default='', blank=True)
    Tbv = models.CharField(max_length=100, default='', blank=True)
    Tbv2 = models.CharField(max_length=100, default='', blank=True)
    TZ = models.CharField(max_length=100, default='', blank=True)
